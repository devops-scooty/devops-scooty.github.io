    ...
    <footer className="bg-blue-900 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-blue-100 mb-6">
              Your everyday delivery, fast and easy. Groceries, food, medicines, and more delivered across Lagos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-blue-100">
              ...
              <li><Link href="/rider" className="hover:text-white transition-colors">Ride with Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-blue-100 mb-4 text-sm">Subscribe to our newsletter for promos and updates.</p>
            ...
            <div className="flex flex-col space-y-2">
              <div className="bg-black text-white px-4 py-2 rounded-md inline-block w-max text-sm cursor-pointer border border-gray-700 hover:border-gray-500">Download on the App Store</div>
              <div className="bg-black text-white px-4 py-2 rounded-md inline-block w-max text-sm cursor-pointer border border-gray-700 hover:border-gray-500">Get it on Google Play</div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-blue-200">
          ...
          <p className="mt-2 md:mt-0">Operated in Lagos, Nigeria 🇳🇬</p>
        </div>
      </div>
    </footer>
  );
